...
#   NOTES:      Script to construct first stage cost instruments using Census data

# Load dependencies:
pacman::p_load(here, data.table, tidyverse, tidycensus)

# Set project root:
i_am("src/R/e_gen_census_vars.R")
...
fwrite(acs_2012, here("data/dwh_replication/acs5yr_2012.csv"))
rm(acs_2012)
