...
# Set project root:
i_am("src/R/e_gen_commuting_time.R")
...
commute <- fread(here("data/dwh_replication/nhgis0028_ds201_20135_zcta.csv"))
...
fwrite(respondents, here("data/dwh_replication/respondents_commutes.csv"))
rm(respondents)
...
ggsave(here( "output/dwh_replication/fig_commute_time.jpg"), plot = fig_commute_time, width = 6, height = 5, units = "in", dpi = 500)
