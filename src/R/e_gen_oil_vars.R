...
production <- jsonlite::fromJSON(paste(readLines(here("data/dwh_replication/eia_intl_crude_prod.txt")), collapse=""))
...
price <- jsonlite::fromJSON(paste(readLines(here("data/dwh_replication/eia_refiner_costs.txt")), collapse=""))
...
fwrite(supply_shock, here("data/dwh_replication/oil_struc_shocks.csv"))
...
ggsave(here( "output/dwh_replication/fig_shock_oilsupply_wide.jpg"), plot = fig.supply, width = 6, height = 3, units = "in", dpi = 500)
ggsave(here( "output/dwh_replication/fig_shock_oilsupply.jpg"), plot = fig.supply, width = 6, height = 4, units = "in", dpi = 500)
...
ggsave(here( "output/dwh_replication/fig_shock_aggdem_wide.jpg"), plot = fig.rea, width = 6, height = 3, units = "in", dpi = 500)
...
ggsave(here( "output/dwh_replication/fig_shock_oildem_wide.jpg"), plot = fig.oil.dem, width = 6, height = 3, units = "in", dpi = 500)
